...
public final class Util {
    ...
    public static String openUrl(String url, String method, Bundle params)
        ...
        if (params.containsKey("timeout")) {
            conn_timeout = params.getInt("timeout");
            read_timeout = params.getInt("timeout");
            params.remove("timeout");
        } else {
            if (params.containsKey("conn_timeout")) {
                conn_timeout = params.getInt("conn_timeout");
                params.remove("conn_timeout");
            }
            if (params.containsKey("read_timeout")) {
                read_timeout = params.getInt("read_timeout");
                params.remove("read_timeout");
            }
        }
